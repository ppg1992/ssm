		...
		<div class="mui-input-group" style="margin-bottom:50px;">	
			<div class="content">
			  ...
			  <div class="mui-input-row" style="border:none ! important;">
				    ...
				    <input id="carNumbers" name="carNumbers" value="${weChatData.carNumbers}" type="text"  class="mui-input-clear"  placeholder="请输入车牌号">
			  </div>
			  ...
			  <div class="mui-input-row">
			    ...
			    <input id="rescueAddress" name="rescueAddress" readonly="readonly" value="${weChatData.rescueAddress}" type="text" class="mui-input-clear"  placeholder="请选择作业地址" onclick="wxaddress('rescueAddress');">
